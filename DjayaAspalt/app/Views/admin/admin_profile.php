...
<div class="container py-4">
    ...
    <div class="row">
        <div class="col-md-3 text-center">
            <img src="<?= base_url('assets/admin_profile_pic.png') ?>" class="img-fluid rounded-circle mb-3" style="width: 150px; height: 150px; object-fit: cover;" alt="Admin Profile Picture">
            ...
            <img src="<?= base_url('assets/admin_worker_laptop.png') ?>" class="img-fluid mt-4" style="max-width: 150px;" alt="Admin Worker">
        </div>
        <div class="col-md-9">
            <div class="card p-4 shadow-sm">
                <form action="<?= base_url('admin/profile/update') ?>" method="post">
                    ...
                    <div class="mb-3 d-flex align-items-center">
                        <img src="<?= base_url('assets/admin_icon.png') ?>" width="24" class="me-2" alt="Admin ID Icon">
                        <label for="id_admin" class="form-label mb-0 me-2">Id Admin</label>
                        <input type="text" class="form-control" id="id_admin" name="id_admin" value="<?= esc($id_admin ?? '') ?>" readonly style="background-color: #f8d7da;">
                    </div>
                    <div class="mb-3 d-flex align-items-center">
